...
const Footer = () => {
  const { location, email, facebook, instagram, tiktok, youtube, advent } =
    images;
  return (
    <div className="flex flex-col md:flex-row md:justify-around md:gap-32 px-8 pt-2 max-sm:pb-8 min-h-[300px] bg-primary-dark text-white">
